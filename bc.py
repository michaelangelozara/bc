...
def draw_window(CHARACTER, start_button_clicked, key_pressed, IMAGE_POSITION, last_direction, character_score, collision_occurred, run, balloons_rect, list_of_balloons, is_game_over, random_number_pos_x, bullet_status, bullet_rect, character_position, is_ready_to_fire, CHARACTER_VEL, BALLOONS_VEL, BULLET_VEL):
  ...
  return IMAGE_POSITION, last_direction, character_score, collision_occurred, run, is_game_over, random_number_pos_x, bullet_status, CHARACTER, bullet_rect, is_ready_to_fire, CHARACTER_VEL, BALLOONS_VEL, BULLET_VEL
...
def main():
  ...
  while run:
    ...
    is_video_ended()
    IMAGE_POSITION, last_direction, character_score, collision_occurred, run, is_game_over, random_number_pos_x, bullet_status, CHARACTER, bullet_rect, is_ready_to_fire, CHARACTER_VEL, BALLOONS_VEL, BULLET_VEL = draw_window(CHARACTER, start_button_clicked, key_pressed, IMAGE_POSITION, last_direction, character_score, collision_occurred, run, balloons_rect, list_of_balloons, is_game_over, random_number_pos_x, bullet_status, bullet_rect, character_position, is_ready_to_fire, CHARACTER_VEL, BALLOONS_VEL, BULLET_VEL)
